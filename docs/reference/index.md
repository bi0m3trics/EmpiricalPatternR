...
- [`allometric_equations`](https://bi0m3trics.github.io/EmpiricalPatternR/reference/allometric_equations.md)
...
- [`should_full_update()`](https://bi0m3trics.github.io/EmpiricalPatternR/reference/should_full_update.md)
  : Batch Update Check
...
- [`simulate_mortality()`](https://bi0m3trics.github.io/EmpiricalPatternR/reference/simulate_mortality.md)
  : Simulate Post-Disturbance Mortality
- [`update_history_efficient()`](https://bi0m3trics.github.io/EmpiricalPatternR/reference/update_history_efficient.md)
...
- [`print_simulation_summary()`](https://bi0m3trics.github.io/EmpiricalPatternR/reference/print_simulation_summary.md)
...
- [`EmpiricalPatternR-package`](https://bi0m3trics.github.io/EmpiricalPatternR/reference/EmpiricalPatternR-package.md)
  [`EmpiricalPatternR`](https://bi0m3trics.github.io/EmpiricalPatternR/reference/EmpiricalPatternR-package.md)
