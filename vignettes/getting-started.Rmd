---
title: "Getting Started with EmpericalPatternR"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with EmpericalPatternR}
...
**EmpiricalPatternR** simulates realistic forest stand patterns using simulated annealing optimization to match empirical targets for:
...
- Species, density, canopy cover, and CFL are all HIGH (60-70)
- Tree size metrics are LOW (1-5) - they emerge from allometry
- Spatial pattern is LOW (10) - emerges from density/size
...
- CSV files (all trees, live trees, history, summary stats)
...
1. **Start with fewer iterations** (1000-5000) to test, then increase to 50000 for final runs
2. **Use high weights** (60-80) for metrics you measured in the field
3. **Use low weights** (0-20) for emergent properties (spatial pattern, tree sizes)
4. **Enable plotting** (`plot_interval = 500`) to watch optimization progress
